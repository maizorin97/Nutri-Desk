...
class Plan(models.Model):
    ...
    idUsuario = models.ForeignKey(
        User, on_delete=models.CASCADE, verbose_name="Id Usuario"
    )
...
class Colacion(models.Model):
    ...
    idTipoComida = models.ForeignKey(
        TipoComida, on_delete=models.CASCADE, verbose_name="Id Tipo Comida"
    )
    ...
    def __str__(self):
        return "plan {0} -> {1}, {2}".format(
            self.idPlan, self.idAlimento, self.idTipoComida
        )
